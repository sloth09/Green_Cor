...
- [x] 200--250 words (228 words)
- [x] At least 3 specific quantitative results ($290.81M, $1.23/ton, 59.6 nm, 5.7%, 2.4--3.0x, 2,500/10,000/5,000 m3)
- [x] No claims not supported by the paper body
- [x] No citations in abstract
- [x] Covers: problem, gap, method, results, implication
