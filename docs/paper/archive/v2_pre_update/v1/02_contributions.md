...
## Contribution 3: Demand-Robust Fleet Sizing -- Optimal Infrastructure Specifications Invariant to 4x Demand Uncertainty
...
|---|-------------|-----|--------------|------------|
| C1 | Optimal infrastructure specs through joint optimization | Gap 1 | Fig. 2 (D1), Fig. 14 (S7) | Case 1: 2,500 m3, $290.81M, $1.23/ton |
| C2 | Break-even distance decision rule | Gap 2 | Fig. 12 (FIG9), Fig. 3 (D10) | Yeosu crossover ~59.6 nm; Ulsan no crossover |
| C3 | Demand-robust fleet sizing | Gap 3 | Fig. 13 (FIG10), Fig. 7 (D8) | LCO $1.21--$1.28/ton across 4x demand |
